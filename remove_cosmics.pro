...
;                     included in the noise model.  3 sigma is good here.
;                
;
...
;                
;
; COMMON BLOCKS:  Uses the common block in ctio.common
;
...
;
;-
; Oct-26-2011 AT Remove common block, add GAIN and RON keywords
